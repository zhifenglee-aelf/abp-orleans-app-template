...
namespace AbpOrleansAppTemplate.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpOrleansAppTemplate") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpOrleansAppTemplate", DisplayName = "AbpOrleansAppTemplate API", Resources = { "AbpOrleansAppTemplate" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AbpOrleansAppTemplate_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AbpOrleansAppTemplate_Swagger:RootUrl"]?.TrimEnd('/');
